    ...
    while gameOver==False:
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
                ...
                while chance==1 and draw!=9:
                    if comp_chance==1:
                        if key5==1:
                            compx=random.choice([160,310])
                            compy=random.choice([125,256])
                        else:
                            compx=240
                            compy=191
                    elif comp_chance>1:
                        if xho1==2 and checkho1==0:
                            if key1==0:
                                compx=160
                                compy=125
                            elif key2==0:
                        ...
                        #if (xho1==0 or xho1==1) and (xho2==0 or xho2==1) and (xho3==0 or xho3==1) and (xve1==0 or xve1==1) and (xve2==0 or xve2==1) and (xve3==0 or xve3==1) and (xdia1==0 or xdia1==1) and (xdia2==0 or xdia2==1):
                            #anything=1

                        #if (xho1!=2 and xho2!=2 and xho3!=2 and xve1!=2 and xve2!=2 and xve3!=2 and xdia1!=2 and xdia2!=2):
                            #anything=1
                        else:
